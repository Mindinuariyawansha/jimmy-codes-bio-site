...
const Contact = () => {
  return (
    <section id="contact" className="py-20 px-6 sm:px-10 bg-muted/50">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">jimmy@example.com</p>
                  </div>
                </div>
            ...
            <div className="bg-accent/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">Need a developer for your project?</h3>
              <p className="mb-4 text-muted-foreground">
                I'm currently available for freelance work and open to new opportunities.
              </p>
              <Button className="bg-primary hover:bg-primary/90">
                <a href="mailto:jimmy@example.com">Hire Me</a>
              </Button>
            </div>
          </div>
        </div>
